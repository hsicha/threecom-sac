...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2023 a las 13:33:50
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_GENERARNUMERODOCUMENTO` (IN `rCodigodocumento` INT, `id_user` INT)   BEGIN
	DECLARE rSerie CHAR(5);
	DECLARE rNumeracion CHAR(7);
    DECLARE rcANTIDAD_VENTA int;
    SET rcANTIDAD_VENTA = (SELECT count(*) FROM VENTA);
	IF rcANTIDAD_VENTA > 0 THEN
		SET rSerie = (select num_serie from tipo_documento WHERE idtipo_documento = rCodigodocumento AND idusuario = id_user);
        SET rNumeracion = (SELECT CONVERT(numero, DECIMAL(7)) + 1 FROM venta
							WHERE idtipo_documento = rCodigodocumento
							ORDER BY idventa DESC
							LIMIT 1);
        SET rNumeracion = LPAD(rNumeracion, 7, '0');
	ELSE 
		SET rSerie = (select num_serie from tipo_documento WHERE idtipo_documento = rCodigodocumento and idusuario = id_user);
        SET rNumeracion = (select nro_inicial FROM tipo_documento WHERE idtipo_documento = rCodigodocumento AND idusuario = id_user);
		SET rNumeracion = LPAD(rNumeracion, 7, '0');
    END if;
    SELECT rSerie, rNumeracion;
END$$
...
(16, '-', 'c001', 'laptop amd  ryzen  5', 8, 18, 4, 8, 13, '1698890636.jpg', '1500', '1200', 18, 1);
...
(7, 'MOBILES', 'CATEGORIA DE EQUIPOS MOBILES', 1),
...
(25, 1, '47661166', 'SICHA ROMANI HERNAN', 'av los lirios S/N', '12345', ''),
...
CREATE TABLE `detalle_venta` (
  ...
  `idarticulo` int(11) NOT NULL,
  `cantidad` int(11) NOT NULL,
  `id_tipo_igv` int(11) DEFAULT NULL,
  `precio_venta` decimal(11,2) NOT NULL,
...
(11, 24, 16, 1, 1, '1500.00', '1500.00'),
(12, 25, 16, 1, 1, '1500.00', '1500.00'),
(13, 26, 16, 1, 1, '1500.00', '1500.00'),
(14, 27, 16, 2, 1, '1500.00', '3000.00'),
(15, 27, 16, 1, 1, '1500.00', '1500.00');
...
(4, 'GONZLES ROMANI LEONILDA', 'FERRETERIA FREDY', '10432017473', 'JR. FREDY VALLADARES', '', '', '', '1698870695.png', 1, NULL);
...
(3, 33, 1, 'Boleta', 'BB01', '123', '2023-08-28 00:00:00', '18.00', '200.00', 'Aceptado'),
(5, 24, 1, 'Boleta', 'bb-01', '23', '2023-09-05 00:00:00', '2.00', '1.00', 'Aceptado');
...
CREATE TABLE `sedes` (
  ...
  `id_ubigeo` int(100) DEFAULT NULL,
...
CREATE TABLE `tipo_contribuyente` (
  `codigo_tipo_cont` int(11) NOT NULL,
  `nombre_contribuyente` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tipo_documento` (
  ...
  `nro_inicial` varchar(10) NOT NULL,
  `nro_final` int(100) NOT NULL,
...
(22, 1, 'FE02', '1', 999999, '2023-10-13 00:32:36', 2, 'ACTIVO'),
(23, 3, 'BE02', '1', 999999, '2023-10-13 00:32:48', 2, 'ACTIVO'),
...
CREATE TABLE `tipo_igvs` (
  `id_tipo_igv` int(11) UNSIGNED NOT NULL,
...
CREATE TABLE `tipo_operaciones` (
  ...
  `tipo_compro_asoc` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ubigeo` (
  ...
  `codigo_ubigeo` varchar(100) NOT NULL,
...
CREATE TABLE `unidad_medida` (
  ...
  `descr_unidad` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'SICHA ROMANI HERNAN', 'DNI', '47661166', 'Jose Gálvez 1368 - Chongoyape', '931742904', '', '', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '1698464276.jpg', 1),
(2, 'CELESTINA APANCCORAY HUARACA', 'DNI', '47661166', 'JR LAS BELLAS PRINCESAS', '97889632', 'CELESTE@GMAIL.COM', 'ADMIN', 'CELESTE', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', '1695617556.jpg', 1),
(3, 'HECTOR MEDINA GARCIA', 'DNI', '48148230', 'PSJ EL SOL 397', '972406385', 'ANTONI.MG.10@GMAIL.COM', 'ASESOR', 'HMEDINA', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '1696446956.png', 1);
...
CREATE TABLE `venta` (
  ...
  `total_inafecta` int(11) NOT NULL,
...
INSERT INTO `venta` (`idventa`, `idcliente`, `idtipo_documento`, `id_operacion`, `serie`, `numero`, `fecha_emision`, `fecha_vemcimiento`, `hora_emision`, `id_forma_pago`, `id_moneda`, `total_gravada`, `total_igv`, `total_gratuita`, `total_exonerada`, `total_inafecta`, `total_venta`, `nota`, `estado`, `idusuario`) VALUES
(24, 26, 20, 1, 'BE01', '0000001', '2023-11-28', '2023-11-28', '15:16:07', 2, 1, '1500.00', 270, '0.00', '0', 0, '1770.00', '', 'Aceptado', 1),
(25, 26, 20, 1, '', '00000001', '2023-11-28', '2023-11-28', '17:22:02', 2, 1, '1500.00', 270, '0.00', '0', 0, '1770.00', '', 'Aceptado', 1),
(26, 25, 19, 1, 'FE001', '00000000', '2023-11-28', '2023-11-28', '17:37:29', 2, 1, '1500.00', 270, '0.00', '0', 0, '1770.00', '', 'Aceptado', 1),
(27, 26, 19, 1, 'FE01', '00000001', '2023-11-30', '2023-11-30', '05:17:08', 2, 1, '4500.00', 810, '0.00', '0', 0, '5310.00', '', 'Aceptado', 1);
...
--
ALTER TABLE `almacen`
  MODIFY `codigo_almacen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `presentacion`
  MODIFY `idpresentacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tipo_documento`
  MODIFY `idtipo_documento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `ubigeo`
  MODIFY `id_ubigeo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3713;
...
--
ALTER TABLE `articulo`
  ADD CONSTRAINT `fk_articulo_almacen` FOREIGN KEY (`codigo_almacen`) REFERENCES `almacen` (`codigo_almacen`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  ADD CONSTRAINT `fk_articulo_presentacion` FOREIGN KEY (`idpresentacion`) REFERENCES `presentacion` (`idpresentacion`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `ingreso`
  ADD CONSTRAINT `fk_ingreso_prov` FOREIGN KEY (`idproveedor`) REFERENCES `proveedor` (`idproveedor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `fk_proveedor_tipo_doc` FOREIGN KEY (`cod_tipo_doc`) REFERENCES `tipo_doc_contribuyente` (`cod_tipo_doc`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `venta`
  ADD CONSTRAINT `fk_venta_formaPagos` FOREIGN KEY (`id_forma_pago`) REFERENCES `forma_pagos` (`id_forma_pago`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_venta_moneda` FOREIGN KEY (`id_moneda`) REFERENCES `monedas` (`id_moneda`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_venta_operacion` FOREIGN KEY (`id_operacion`) REFERENCES `tipo_operaciones` (`id_operacion`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_venta_persona` FOREIGN KEY (`idcliente`) REFERENCES `clientes` (`idcliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_venta_tipodoc` FOREIGN KEY (`idtipo_documento`) REFERENCES `tipo_documento` (`idtipo_documento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
