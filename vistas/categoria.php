              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                        ...
                        <button class="btn btn-primary btn-flat" id="btnagregar" data-toggle="modal" data-target=".myModal" onclick="limpiar();"><i class="fa fa-plus-circle"></i> NUEVA CATEGORIA</button>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <!-- centro -->
