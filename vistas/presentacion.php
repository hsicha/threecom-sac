            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <h1 class="box-title">PRESENTACION  </h1>
                        <div class="box-tools pull-right">
                        <button class="btn btn-primary btn-flat" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> NUEVA PRESENTACION</button>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <!-- centro -->
